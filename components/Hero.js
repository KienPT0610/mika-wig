  ...
  return (
    <section className="bg-img-2 py-20">
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8 items-center">
        <div>
          <h1 className="text-4xl md:text-5xl font-playfair mb-4 text-hero">Mika.wig — Tóc giả cao cấp</h1>
          <p className="text-lg text-hero mb-6">Tạo phong cách tự nhiên, nâng tầm sự tự tin với tóc giả thủ công bởi nghệ nhân Mai.</p>
